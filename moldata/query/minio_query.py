...
class MinIOQuery:
    ...
    Args:
        manifest_path: Path to a parquet manifest generated by moldata.
    ...
    def manifest(self) -> Manifest:
        if self._manifest is None:
            ...
            self._manifest = Manifest.load_parquet(Path(self.manifest_path))
            logger.info("Loaded manifest: %d entries from %s", self._manifest.count(), self.manifest_path)
